...
public class BlockCobbleGen extends BlockContainer {
    ...
    protected BlockCobbleGen(int var1, int var2, Material var3, int tier, int var4, int var5) {
    ...
    protected TileEntity getBlockEntity() {
    	TileEntityCobbleGen tileEnt = new TileEntityCobbleGen();
    	tileEnt.tier = this.tier;
        return tileEnt;
    }

    public void onBlockRemoval(World var1, int var2, int var3, int var4) {
    	TileEntityCobbleGen var5 = (TileEntityCobbleGen)var1.getBlockTileEntity(var2, var3, var4);
    ...
    public boolean blockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5) {
        Object var6 = (TileEntityCobbleGen)var1.getBlockTileEntity(var2, var3, var4);
        if (var1.isBlockNormalCube(var2, var3 + 1, var4)) {
            ...
            if (var1.multiplayerWorld) {
            	...
            	ModLoader.getMinecraftInstance().displayGuiScreen(new GuiCobbleGen(var5.inventory, (IInventory)var6));
