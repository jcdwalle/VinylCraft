...
public class BlockCustomChest extends BlockContainer {
    private Random random = new Random();

    protected BlockCustomChest(int var1, int var2, Material var3) {
    ...
    public void onBlockRemoval(World var1, int var2, int var3, int var4) {
        TileEntityCrate var5 = (TileEntityCrate)var1.getBlockTileEntity(var2, var3, var4);
    ...
    public boolean blockActivated(World var1, int var2, int var3, int var4, EntityPlayer var5) {
        Object var6 = (TileEntityCrate)var1.getBlockTileEntity(var2, var3, var4);
        if (var1.isBlockNormalCube(var2, var3 + 1, var4)) {
            ...
            if (var1.multiplayerWorld) {
            	...
            	ModLoader.getMinecraftInstance().displayGuiScreen(new GuiCrate(var5.inventory, (IInventory)var6));
