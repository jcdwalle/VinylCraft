...
public class ContainerIndustrialExtractor extends Container {
    private TileEntityIndustrialExtractor furnace;
    private int cookTime = 0;
    private int burnTime = 0;
    private int itemBurnTime = 0;

    public ContainerIndustrialExtractor(InventoryPlayer var1, TileEntityIndustrialExtractor var2) {
        this.furnace = var2;
